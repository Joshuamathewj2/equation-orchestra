    ...
    <div className="flex-1 w-full min-h-screen text-white flex flex-col items-center justify-between p-4 md:p-8 relative select-none font-sans overflow-x-hidden">
      ...
      <AnimatePresence mode="wait">
        {!isUnlocked ? (
          ...
          >
            <div className="p-4 rounded-3xl bg-indigo-950/40 border border-indigo-500/20 shadow-2xl shadow-indigo-500/10 mb-6 relative">
              <Torus className="w-16 h-16 text-indigo-400 animate-[spin_8s_linear_infinite]" />
              <div className="absolute inset-0 rounded-3xl bg-indigo-500/5 blur-xl animate-pulse" />
            </div>
            ...
            <p className="text-xs md:text-sm text-zinc-400 leading-relaxed max-w-lg mb-10 font-normal">
              Step into a mathematical soundscape where math equations are mapped to specific musical instrument timbres. Mix, solo, and sequence sines, Fourier series, and exponential decay pulses in real-time.
            </p>

            {/* Lock Unlock Giant Landing Button */}
            <button
              onClick={unlockAudioContext}
              className="px-8 py-5 rounded-2xl bg-gradient-to-r from-indigo-600 via-fuchsia-600 to-pink-600 text-white font-bold tracking-[0.25em] text-xs md:text-sm shadow-xl shadow-indigo-500/20 hover:shadow-indigo-500/40 hover:scale-[1.03] active:scale-[0.98] transition-all duration-300 flex items-center gap-3 cursor-pointer group uppercase border border-white/10"
            >
          ...
          >
            ...
            <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
              ...
              <div className="lg:col-span-5 bg-zinc-950/70 border border-zinc-900 rounded-2xl p-5 md:p-6 shadow-2xl flex flex-col justify-between backdrop-blur-md relative overflow-hidden min-h-[160px]">
                ...
                <div className="text-[8px] text-zinc-600 font-mono mt-4 text-right">
            ...
            <footer className="bg-zinc-950/50 border border-zinc-900 p-4 rounded-2xl flex gap-3.5 items-start mt-4">
              ...
              <div className="flex-1 flex flex-col justify-center">
                ...
                <p className="text-[11px] text-zinc-400 leading-relaxed font-normal">
                  In classical physics, mathematical functions correspond to physical shapes of waves. Timbre is created by stacking harmonic integers or adding inharmonic frequencies (inharmonicity). By scheduling ADSR volume envelopes alongside Web Audio synthesizers, this digital stage translates formulas directly into audible instruments.
                </p>
              </div>
            </footer>
