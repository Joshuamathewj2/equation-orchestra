...
export const INSTRUMENTS: InstrumentConfig[] = [
  {
    ...
    defaultSteps: [true, false, false, true, false, false, true, false, true, false, false, true, false, false, true, false],
  ...
  },
  {
    ...
    defaultSteps: [false, true, false, false, false, true, false, false, false, true, false, false, false, true, false, false],
    formula: (x: number) => {
      let y = 0;
      for (let n = 1; n <= 8; n++) {
  ...
  },
  {
    ...
    defaultSteps: [true, false, false, false, false, false, false, false, true, false, false, false, false, false, false, true],
    formula: (x: number) => {
  ...
  },
  {
    ...
    defaultSteps: [false, false, false, false, true, false, false, false, false, false, false, false, true, false, false, false],
    formula: (x: number) => {
  ...
  },
  {
    ...
    defaultSteps: [true, false, true, false, true, false, false, true, false, true, false, true, true, false, false, true],
    formula: (x: number) => {
      let y = 0;
      for (let k = 0; k <= 8; k++) {
        const n = 2 * k + 1;
  ...
  },
  {
    ...
    defaultSteps: [true, false, false, false, false, false, false, true, true, false, false, false, false, true, false, false],
    formula: (x: number) => {
